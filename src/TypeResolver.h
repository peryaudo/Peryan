...
public:
	...
	Type *visit(Label *label);
	Type *visit(BinaryExpr *be);
	Type *visit(UnaryExpr *ue);
	Type *visit(IntLiteralExpr *lit);
	Type *visit(StrLiteralExpr *lit);
	Type *visit(CharLiteralExpr *lit);
	Type *visit(FloatLiteralExpr *lit);
	Type *visit(BoolLiteralExpr *lit);
	Type *visit(ArrayLiteralExpr *ale);
	Type *visit(FuncCallExpr *fce);
	Type *visit(ConstructorExpr **cePtr);
	Type *visit(SubscrExpr *se);
	Type *visit(MemberExpr **mePtr);
	Type *visit(StaticMemberExpr *sme);
	Type *visit(DerefExpr *de);
	Type *visit(RefExpr *re);
};
